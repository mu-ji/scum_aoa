...
data = np.load('SCuM_ondesk_experiment/-40_data.npz')
print(data)

I_data_array = data['I_data']
Q_data_array = data['Q_data']
rssi_array = data['rssi']
music_angle_array = data['music_angle']
grid_search_angle_array = data['grid_search_angle']
angle_change_1us_array = data['angle_change_1us']
...
music_result = np.zeros((11,50))
grid_search_result = np.zeros((11,50))
for index in range(len(angle_list)):
    data = np.load('SCuM_ondesk_experiment/{}_data.npz'.format(angle_list[index]))
    I_data_array = data['I_data']
    Q_data_array = data['Q_data']
    rssi_array = data['rssi']
    music_angle_array = data['music_angle']
